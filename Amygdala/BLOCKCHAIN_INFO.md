...
- `blockchain/pham_chain_amygdala_engine.json` - 핵심 엔진 파일
...
```json
{
  ...
  "data": {
    "title": "amygdala_engine.py",
    "hash": "abc123...",
    "author": "GNJz",
    "description": "Amygdala Engine 초기 구현",
    "signals": {
      "byte": 0.85,
      "text": 0.90,
      "ast": 0.80,
...
python3 pham_sign_v4.py \
    ../../7.Amygdala_Engine/package/amygdala/amygdala_engine.py \
    --author "GNJz" \
    --desc "Amygdala Engine 초기 구현" \
    --exec "python3 -m pytest ../../7.Amygdala_Engine/tests/ -v"
```
...
```bash
python3 pham_sign_v4.py --stats blockchain/pham_chain_amygdala_engine.json
```
